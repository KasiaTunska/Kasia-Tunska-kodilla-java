...
public class InvoiceDaoTestSuite {
    ...
    public void testInvoiceDaoSave(){
        ...
        Product product2 = new Product("window");
        Product product3 = new Product("chocolate");
        Product product4 = new Product("book");

        Invoice invoice1 = new Invoice("2154567");
        Invoice invoice2 = new Invoice("2151234");
        Invoice invoice3 = new Invoice("2158901");
        Invoice invoice4 = new Invoice("2150001");
